"""
VisCache_Ladder11.py - Step 11 v3: bayer x cell-footprint matrix.
...
Sweep: bayer in {2, 4} x fd in {1, 4, 16, 64} = 8 variants. Single ct=64.

  bayer  fd   layout
  2x2    1x1  bayer larger than cell (4 slots, 1 px cell)
  2x2    2x2  matched (4 slots, 4 px cell)
  2x2    4x4  cell larger than bayer
  2x2    8x8  cell much larger than bayer
  4x4    1x1  bayer much larger than cell
  4x4    2x2  bayer larger than cell
  4x4    4x4  matched (16 slots, 16 px cell)
  4x4    8x8  cell larger than bayer
