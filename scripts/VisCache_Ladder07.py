...
from VisCache_LadderCommon import run_variants, run_baseline, get_scenes, \
    plot_overviews, copy_summary_to_root, make_norm_variants, PRESET_MINIMAL, RR_ADAPTIVE, \
    LEVELS_MULTI, QUALITY_DEFAULT, FOOTPRINT_ON, SUBFRAME_2x2

res = int(os.environ.get("RES", "512"))

STEP_OVERRIDES = {**RR_ADAPTIVE, **LEVELS_MULTI, **QUALITY_DEFAULT, **FOOTPRINT_ON, **SUBFRAME_2x2}
...
for scene_file in get_scenes():
    ...
    run_variants(
        step_name="07",
        frame_configs=[(1, 0, 1, 1), (1, 0, 16, 1)],
        scene_file=scene_file,
