...
REM
REM Usage:  scripts\quickstart.bat [--scene Bistro|Sponza|Arcade] [--skip-scenes] [--skip-pull] [--skip-launch]
REM
REM Steps:
...
echo Usage: %~nx0 [--scene Bistro^|Sponza^|Arcade] [--skip-scenes] [--skip-pull] [--skip-launch]
exit /b 1
:args_done
