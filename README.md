...
| Localized spatial hash cache against curse of dimensionality | [Ward 1991][r-ward] (visibility caching concept predates 2006), [Guo et al. 2020][r-guo] (NEE++, dense D³×D³ matrix — hits the dimensionality wall), [SHaRC (Benyoub et al. 2024)][r-sharc] (world-space spatial hash, RTX SDK), [Popov et al. 2013][r-popov] (adaptive octree, offline) | 2006 used spatial hashing to store pairwise visibility in compact world-space cells instead of dense high-dimensional tables; NEE++ later hit the same dimensionality problem with its 16³×16³ matrix |
