...
| Cache-weighted light selection | [Bokšanský & Meister 2025][r-boksansky] (μ-weighted reservoir sampling) | Parallel rediscovery of using cached μ to weight ReSTIR candidate selection (our Sec. 9.1) |
