...
| Spatial hash map against curse of dimensionality | [Guo et al. 2020][r-guo] (NEE++, dense D³×D³ matrix — hits the dimensionality wall), [SHaRC (Benyoub et al. 2024)][r-sharc] (world-space spatial hash, RTX SDK) | 2006 used spatial hashing for compact pairwise storage instead of dense high-dimensional tables; NEE++ later hit the same problem with its 16³×16³ matrix (~32 MB, single resolution) |
