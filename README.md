...
| Localized cache for high-quality per-point estimates | [Ward 1991][r-ward] (visibility caching concept predates 2006), [Guo et al. 2020][r-guo] (NEE++, per-voxel-pair visibility), [Bokšanský & Meister 2025][r-boksansky] (neural per-point visibility), [Popov et al. 2013][r-popov] (adaptive quantization, offline) | 2006 used per-point cached predictions (not scene-global averages) as CV estimation source — what makes CV+VRRR effective; Szirmay-Kalos 2005 used a scene-global constant |
