...
| Visibility cache + cache-weighted light selection | [Bokšanský & Meister 2025][r-boksansky] (neural visibility cache + μ-weighted reservoir sampling for light selection) | Parallel rediscovery of the full pipeline: cached visibility for shadow ray reduction *and* using cached μ to weight ReSTIR candidate selection (our Sec. 9.1). Uses Instant-NGP backbone instead of spatial hash; same idea, different data structure |
