...
set "PLUGIN_DIRS=%ROOT%Source\RenderPasses\PathTraceCommon;%ROOT%Source\RenderPasses\CacheCommon;%ROOT%Source\RenderPasses\ReSTIRCommon;%ROOT%Source\RenderPasses\VisCache;%ROOT%Source\RenderPasses\ReSTIRPTReferencePass;%ROOT%Source\RenderPasses\ReSTIRPTPass;%ROOT%Source\RenderPasses\ReSTIRDIPass;%ROOT%Source\RenderPasses\ReSTIRDIReferencePass;%ROOT%Source\RenderPasses\ReSTIRNEEPass;%ROOT%Source\RenderPasses\ReSTIRBDPTPass;%ROOT%Source\RenderPasses\BDPTPass;%ROOT%Source\RenderPasses\PathTracerX"
