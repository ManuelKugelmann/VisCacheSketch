...
set "PLUGIN_DIRS=%ROOT%Source\RenderPasses\Common;%ROOT%Source\RenderPasses\VisCache;%ROOT%Source\RenderPasses\ReSTIRPTReferencePass;%ROOT%Source\RenderPasses\ReSTIRPTPass;%ROOT%Source\RenderPasses\ReSTIRDIPass;%ROOT%Source\RenderPasses\ReSTIRDIReferencePass;%ROOT%Source\RenderPasses\ReSTIRNEEPass;%ROOT%Source\RenderPasses\PathTracerX"
