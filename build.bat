...
set "PLUGIN_DIRS=%ROOT%Source\RenderPasses\PathTraceCore;%ROOT%Source\RenderPasses\ReSTIRCommon;%ROOT%Source\RenderPasses\VisCache;%ROOT%Source\RenderPasses\ReSTIRPTReferencePass;%ROOT%Source\RenderPasses\ReSTIRPTPass;%ROOT%Source\RenderPasses\ReSTIRDIPass;%ROOT%Source\RenderPasses\ReSTIRDIReferencePass;%ROOT%Source\RenderPasses\ReSTIRNEEPass;%ROOT%Source\RenderPasses\PathTracerX"
