 ...
 **************************************************************************/
#include "ReSTIRPTReferencePass.h"
...
{
    registry.registerClass<RenderPass, ReSTIRPTReferencePass>();
}

namespace
{

    const std::string kGeneratePathsFilename = "RenderPasses/ReSTIRPTReferencePass/GeneratePaths.cs.slang";
    const std::string kTracePassFilename = "RenderPasses/ReSTIRPTReferencePass/TracePass.cs.slang";
    const std::string kReflectTypesFile = "RenderPasses/ReSTIRPTReferencePass/ReflectTypes.cs.slang";
    const std::string kSpatialReusePassFile = "RenderPasses/ReSTIRPTReferencePass/SpatialReuse.cs.slang";
    const std::string kTemporalReusePassFile = "RenderPasses/ReSTIRPTReferencePass/TemporalReuse.cs.slang";
    const std::string kSpatialPathRetraceFile = "RenderPasses/ReSTIRPTReferencePass/SpatialPathRetrace.cs.slang";
    const std::string kTemporalPathRetraceFile = "RenderPasses/ReSTIRPTReferencePass/TemporalPathRetrace.cs.slang";
    const std::string kComputePathReuseMISWeightsFile = "RenderPasses/ReSTIRPTReferencePass/ComputePathReuseMISWeights.cs.slang";
...
ref<ReSTIRPTReferencePass> ReSTIRPTReferencePass::create(ref<Device> pDevice, const Properties& props)
{
    return make_ref<ReSTIRPTReferencePass>(pDevice, props);
}

ReSTIRPTReferencePass::ReSTIRPTReferencePass(ref<Device> pDevice, const Properties& props)
    : RenderPass(pDevice)
{
    ...
    // Try sub-path first (CMake deploys to data/ReSTIRPTReferencePass/), then bare name.
    auto fullpath = AssetResolver::getDefaultResolver().resolvePath("ReSTIRPTReferencePass/16RooksPattern256.txt");
    if (fullpath.empty())
...
bool ReSTIRPTReferencePass::parseDictionary(const Properties& props)
{
    ...
    for (const auto& [key, value] : props)
    {
        ...
        else logWarning("Unknown field '{}' in ReSTIRPTReferencePass properties.", key);
    }
...
void ReSTIRPTReferencePass::validateOptions()
{
...
Properties ReSTIRPTReferencePass::getProperties() const
{
...
RenderPassReflection ReSTIRPTReferencePass::reflect(const CompileData& compileData)
{
...
void ReSTIRPTReferencePass::compile(RenderContext* pContext, const CompileData& compileData)
{
...
void ReSTIRPTReferencePass::setScene(RenderContext* pRenderContext, const ref<Scene>& pScene)
{
    mpScene = pScene;
...
void ReSTIRPTReferencePass::execute(RenderContext* pRenderContext, const RenderData& renderData)
{
...
void ReSTIRPTReferencePass::renderUI(Gui::Widgets& widget)
{
    bool dirty = false;
...
ref<Texture> ReSTIRPTReferencePass::createNeighborOffsetTexture(uint32_t sampleCount)
{
...
bool ReSTIRPTReferencePass::renderRenderingUI(Gui::Widgets& widget)
{
    bool dirty = false;
...
bool ReSTIRPTReferencePass::renderDebugUI(Gui::Widgets& widget)
{
    bool dirty = false;
...
bool ReSTIRPTReferencePass::renderStatsUI(Gui::Widgets& widget)
{
    bool dirty = false;
...
bool ReSTIRPTReferencePass::onMouseEvent(const MouseEvent& mouseEvent)
{
    return mpPixelDebug->onMouseEvent(mouseEvent);
}

void ReSTIRPTReferencePass::resetPrograms()
{
...
void ReSTIRPTReferencePass::updatePrograms()
{
...
void ReSTIRPTReferencePass::prepareResources(RenderContext* pRenderContext, const RenderData& renderData)
{
...
void ReSTIRPTReferencePass::setNRDData(const ShaderVar& var, const RenderData& renderData) const
{
...
void ReSTIRPTReferencePass::preparePathTracer(const RenderData& renderData)
{
...
void ReSTIRPTReferencePass::resetLighting()
{
...
void ReSTIRPTReferencePass::prepareMaterials(RenderContext* pRenderContext)
{
...
bool ReSTIRPTReferencePass::prepareLighting(RenderContext* pRenderContext)
{
...
void ReSTIRPTReferencePass::setShaderData(const ShaderVar& var, const RenderData& renderData, bool isPathTracer, bool isPathGenerator) const
{
...
bool ReSTIRPTReferencePass::beginFrame(RenderContext* pRenderContext, const RenderData& renderData)
{
    if (mOptionsChanged)
    {
        mReservoirFrameCount = 0;
...
void ReSTIRPTReferencePass::endFrame(RenderContext* pRenderContext, const RenderData& renderData)
{
...
void ReSTIRPTReferencePass::generatePaths(RenderContext* pRenderContext, const RenderData& renderData, int sampleId)
{
...
void ReSTIRPTReferencePass::tracePass(RenderContext* pRenderContext, const RenderData& renderData, const ref<ComputePass>& pass, const std::string& passName, int sampleID)
{
...
void ReSTIRPTReferencePass::PathReusePass(RenderContext* pRenderContext, uint32_t restir_i, const RenderData& renderData, bool isTemporalReuse, int spatialRoundId, bool isLastRound)
{
...
void ReSTIRPTReferencePass::PathRetracePass(RenderContext* pRenderContext, uint32_t restir_i, const RenderData& renderData, bool temporalReuse /*= false*/, int spatialRoundId /*= 0*/)
{
...
DefineList ReSTIRPTReferencePass::StaticParams::getDefines(const ReSTIRPTReferencePass& owner) const
{
    DefineList defines;
