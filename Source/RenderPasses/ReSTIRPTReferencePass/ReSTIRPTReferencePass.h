...
*/
class ReSTIRPTReferencePass : public RenderPass
{
public:
    FALCOR_PLUGIN_CLASS(ReSTIRPTReferencePass, "ReSTIRPTReferencePass",
                        "ReSTIR PT path tracer using DXR 1.1 TraceRayInline");

    static ref<ReSTIRPTReferencePass> create(ref<Device> pDevice, const Properties& props);
...
private:
    ...
    ReSTIRPTReferencePass(ref<Device> pDevice, const Properties& props);
    ...
    */
    struct StaticParams
    {
        ...
        DefineList getDefines(const ReSTIRPTReferencePass& owner) const;
    };
