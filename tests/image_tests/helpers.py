"""
helpers.py — Test utilities for VisCache image tests.

Mirrors Falcor/tests/image_tests/helpers.py so our tests can run
with the same Mogwai-based image test infrastructure.
"""
