...
for pass in VisCache ReSTIRPTPass ReSTIRPTReferencePass ReSTIRDIPass ReSTIRDIReferencePass ReSTIRNEEPass ReSTIRBDPTPass BDPTPass PathTracerX PathTraceCommon CacheCommon ReSTIRCommon; do
