...
- Teschner et al. 2003 — spatial hashing (taught in Keller's CG lectures at Ulm; pedagogical root)
...
addressing. Taught in Keller's CG simulation lectures at Ulm — likely the common
pedagogical root for both Kugelmann 2006 and Binder 2018.
...
Extends ReSTIR DI to joint lens×light area sampling for depth-of-field and antialiasing.
Final shadow ray structure is identical to standard RTXDI.

**VisCache link:** Demonstrates that CV+RRR integrates without modification at the
same post-shading shadow ray point. Orthogonal extension — not a comparison target,
but validates generality of the VisCache integration API.

**Transitive citations:** None beyond ReSTIR DI.
